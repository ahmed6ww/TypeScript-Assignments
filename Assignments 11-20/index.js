...
let transportation = ['Audi', 'Bikes', 'Helicopter'];
...
let invitation = ['Ammar', 'Shayan', 'Sir Arshad'];
function people() {
...
let places = [`New York City`, `Amsterdam`, `Japan`, `Gilgit`, `Silicon valley`];
for (let place of places) {
    console.log(place);
}
let orignalArray = [...places]; //Copy of orignal array
places.sort();
console.log(places);
function plArrat() {
...
let languages = [`French`, `German`, `Latin`, `Spanish`, `Russian`, `Urdu`];
languages.sort();
